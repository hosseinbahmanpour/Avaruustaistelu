...
/**
 * Tässä luokassa kuunnellaan näppäimistöä ja muutetaan 
 * pelaajien alusten boolean arvoja sekä ammutaan.
...
public class NappaimistonKuuntelija implements KeyListener {
    ...
    /**
     * metodi muuttaa pelaaiien alusten boolean arvoja
     * perustuen siihen että nappia ei paineta.
